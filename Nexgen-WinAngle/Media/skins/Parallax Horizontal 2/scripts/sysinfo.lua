...
function sysinfo.getMemory(FontSelect, MemPositionX, MemPositionY, MemSpacing, dt)
		...
		--graphics.drawFont(FontSelect, physicalTextPosition + fpsTextSize, maths.toInteger(totalPhysical / 1073741824) .." GB")
		graphics.drawFont(FontSelect, physicalTextPosition + fpsTextSize, maths.toInteger(totalPhysical / 1048576) .." MB")
		--graphics.drawFont(FontSelect, physicalTextPosition + fpsTextSize, maths.toInteger(totalPhysical / 1024) .." KB")
		--graphics.drawFont(FontSelect, physicalTextPosition + fpsTextSize, maths.toInteger(totalPhysical) .." B")		
		...
		graphics.setColorTint(TextColour2) 
		--graphics.drawFont(FontSelect, physicalFreeTextPosition + fpsTextSize, maths.toInteger(freePhysical / 1073741824) .." GB")
		graphics.drawFont(FontSelect, physicalFreeTextPosition + fpsTextSize, maths.toInteger(freePhysical / 1048576) .." MB")
		--graphics.drawFont(FontSelect, physicalFreeTextPosition + fpsTextSize, maths.toInteger(freePhysical / 1024) .." KB")
		...
		graphics.setColorTint(TextColour2) 
		--graphics.drawFont(FontSelect, physicalUsedTextPosition + fpsTextSize, maths.toInteger(totalPhysical / 1073741824) - maths.toInteger(freePhysical / 1073741824) .." GB")
		graphics.drawFont(FontSelect, physicalUsedTextPosition + fpsTextSize, maths.toInteger(totalPhysical / 1048576) - maths.toInteger(freePhysical / 1048576) .." MB")
		--graphics.drawFont(FontSelect, physicalUsedTextPosition + fpsTextSize, maths.toInteger(totalPhysical / 1024) - maths.toInteger(freePhysical / 1024)  .." KB")
		--graphics.drawFont(FontSelect, physicalUsedTextPosition + fpsTextSize, maths.toInteger(totalPhysical) - maths.toInteger(freePhysical) .." B" )
		graphics.setColorTint(TextColour1Default)  
		...
		graphics.setColorTint(TextColour2)
		--graphics.drawFont(FontSelect, vitualTextPosition + fpsTextSize, maths.toInteger(totalVirtual / 1073741824) .." GB")
		graphics.drawFont(FontSelect, vitualTextPosition + fpsTextSize, maths.toInteger(totalVirtual / 1048576) .." MB")
		--graphics.drawFont(FontSelect, vitualTextPosition + fpsTextSize, maths.toInteger(totalVirtual / 1024) .." KB")
		--graphics.drawFont(FontSelect, vitualTextPosition + fpsTextSize, maths.toInteger(totalVirtual) .." B")
		graphics.setColorTint(TextColour1Default)  
		...
		graphics.setColorTint(TextColour2)
		--graphics.drawFont(FontSelect, virtualFreeTextPosition + fpsTextSize, maths.toInteger(freeVirtual / 1073741824) .." GB")
		graphics.drawFont(FontSelect, virtualFreeTextPosition + fpsTextSize, maths.toInteger(freeVirtual / 1048576) .." MB")
		--graphics.drawFont(FontSelect, virtualFreeTextPosition + fpsTextSize, maths.toInteger(freeVirtual / 1024) .." KB")
		...
		graphics.setColorTint(TextColour2)
		--graphics.drawFont(FontSelect, virtualUsedTextPosition + maths.toInteger(totalVirtual / 1073741824) - maths.toInteger(freeVirtual / 1073741824) .." GB")
		graphics.drawFont(FontSelect, virtualUsedTextPosition + fpsTextSize, maths.toInteger(totalVirtual / 1048576) - maths.toInteger(freeVirtual / 1048576) .." MB")
