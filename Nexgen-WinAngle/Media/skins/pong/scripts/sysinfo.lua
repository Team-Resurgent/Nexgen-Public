...
function sysinfo.getMemory()
		...
		--Graphics.drawFont(fontId, physicalTextPosition, "Physical Memory: " .. Maths.toInteger(totalPhysical / 1073741824) .." GB" )
		Graphics.drawFont(fontId, physicalTextPosition, "Physical Memory: " .. Maths.toInteger(totalPhysical / 1048576) .." MB" )
		--Graphics.drawFont(fontId, physicalTextPosition, "Physical Memory: " .. Maths.toInteger(totalPhysical / 1024) .." KB" )
		--Graphics.drawFont(fontId, physicalTextPosition, "Physical Memory: " .. Maths.toInteger(totalPhysical) .." B" )
		...
		Graphics.setColorTint(TextColour1)
		-- Graphics.drawFont(fontId, physicalFreeTextPosition, "Free Physical Memory: " .. Maths.toInteger(freePhysical / 1073741824) .." GB" )
		Graphics.drawFont(fontId, physicalFreeTextPosition, "Free Physical Memory: " .. Maths.toInteger(freePhysical / 1048576) .." MB" )
		--Graphics.drawFont(fontId, physicalFreeTextPosition, "Free Physical Memory: " .. Maths.toInteger(freePhysical / 1024) .." KB" )
		--Graphics.drawFont(fontId, physicalFreeTextPosition, "Free Physical Memory: " .. Maths.toInteger(freePhysical) .." B" )
		Graphics.setColorTint(TextColour1Default)  	
		
		local physicalUsedTextPosition = Vector3.new(65, 460, 0)
		Graphics.setColorTint(TextColour1)
		--Graphics.drawFont(fontId, physicalUsedTextPosition, "Used Physical Memory: " .. Maths.toInteger(totalPhysical / 1073741824) - Maths.toInteger(freePhysical / 1073741824) .." GB" )
		Graphics.drawFont(fontId, physicalUsedTextPosition, "Used Physical Memory: " .. Maths.toInteger(totalPhysical / 1048576) - Maths.toInteger(freePhysical / 1048576) .." MB" )
        --Graphics.drawFont(fontId, physicalUsedTextPosition, "Used Physical Memory: " .. Maths.toInteger(totalPhysical / 1024) - Maths.toInteger(freePhysical / 1024)  .." KB" )
		--Graphics.drawFont(fontId, physicalUsedTextPosition, "Used Physical Memory: " .. Maths.toInteger(totalPhysical) - Maths.toInteger(freePhysical) .." B" )
		Graphics.setColorTint(TextColour1Default)  

		local totalVirtual = systemGetTotalVirtualMemory()
		local vitualTextPosition = Vector3.new(65, 440, 0)
		Graphics.setColorTint(TextColour1)
		--Graphics.drawFont(fontId, vitualTextPosition, "Virtual Memory: " .. Maths.toInteger(totalVirtual / 1073741824) .." GB" )
		Graphics.drawFont(fontId, vitualTextPosition, "Virtual Memory: " .. Maths.toInteger(totalVirtual / 1048576) .." MB" )
		--Graphics.drawFont(fontId, vitualTextPosition, "Virtual Memory: " .. Maths.toInteger(totalVirtual / 1024) .." KB" )
		--Graphics.drawFont(fontId, vitualTextPosition, "Virtual Memory: " .. Maths.toInteger(totalVirtual) .." B" )
		Graphics.setColorTint(TextColour1Default)  
		
		local freeVirtual = systemGetFreeVirtualMemory()
        local virtualFreeTextPosition = Vector3.new(65, 420, 0)
		Graphics.setColorTint(TextColour1)
		--Graphics.drawFont(fontId, virtualFreeTextPosition, "Free Virtual Memory: " .. Maths.toInteger(freeVirtual / 1073741824) .." GB" )
		Graphics.drawFont(fontId, virtualFreeTextPosition, "Free Virtual Memory: " .. Maths.toInteger(freeVirtual / 1048576) .." MB" )
        --Graphics.drawFont(fontId, virtualFreeTextPosition, "Free Virtual Memory: " .. Maths.toInteger(freeVirtual / 1024) .." KB" )
		--Graphics.drawFont(fontId, virtualFreeTextPosition, "Free Virtual Memory: " .. Maths.toInteger(freeVirtual) .." B" )
		Graphics.setColorTint(TextColour1Default)  
		
		local virtualUsedTextPosition = Vector3.new(65, 400, 0)
		Graphics.setColorTint(TextColour1)
		--Graphics.drawFont(fontId, virtualUsedTextPosition, "Used Virtual Memory: " .. Maths.toInteger(totalVirtual / 1073741824) - Maths.toInteger(freeVirtual / 1073741824) .." GB" )
		Graphics.drawFont(fontId, virtualUsedTextPosition, "Used Virtual Memory: " .. Maths.toInteger(totalVirtual / 1048576) - Maths.toInteger(freeVirtual / 1048576) .." MB" )
        --Graphics.drawFont(fontId, virtualUsedTextPosition, "Used Virtual Memory: " .. Maths.toInteger(totalVirtual / 1024) - Maths.toInteger(freeVirtual / 1024)  .." KB" )
		--Graphics.drawFont(fontId, virtualUsedTextPosition, "Used Virtual Memory: " .. Maths.toInteger(totalVirtual) - Maths.toInteger(freeVirtual) .." B" )
		Graphics.setColorTint(TextColour1Default)  
